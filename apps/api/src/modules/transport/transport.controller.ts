...
export async function updateVehicle(req: Request, res: Response) { res.json({ data: await transportService.updateVehicle(req.user!.tenantSchema, req.params.id, req.body) }); }
...
export async function getRoute(req: Request, res: Response)     { res.json({ data: await transportService.getRoute(req.user!.tenantSchema, req.params.id) }); }
...
export async function updateRoute(req: Request, res: Response)  { res.json({ data: await transportService.updateRoute(req.user!.tenantSchema, req.params.id, req.body) }); }

// Stops
export async function createStop(req: Request, res: Response)   { res.status(201).json({ data: await transportService.upsertStop(req.user!.tenantSchema, req.params.routeId, req.body) }); }
export async function updateStop(req: Request, res: Response)   { res.json({ data: await transportService.upsertStop(req.user!.tenantSchema, req.params.routeId, req.body, req.params.stopId) }); }
export async function deleteStop(req: Request, res: Response)   { await transportService.deleteStop(req.user!.tenantSchema, req.params.routeId, req.params.stopId); res.json({ message: 'Stop deleted' }); }
...
export async function removeStudent(req: Request, res: Response)  { await transportService.removeStudent(req.user!.tenantSchema, req.params.studentId); res.json({ message: 'Student removed from route' }); }
...
export async function getTripDetail(req: Request, res: Response){ res.json({ data: await transportService.getTripDetail(req.user!.tenantSchema, req.params.id) }); }
...
export async function markBoarding(req: Request, res: Response) {
  ...
  res.json({ data: await transportService.markBoarding(req.user!.tenantSchema, req.params.id, student_id, boarded) });
}
export async function completeTrip(req: Request, res: Response){ res.json({ data: await transportService.completeTrip(req.user!.tenantSchema, req.params.id) }); }
...
export async function getStudentTransport(req: Request, res: Response): Promise<void> {
  ...
  const data = await transportService.getStudentTransport(schema, studentId);
  res.json({ data });
}
...
export async function updateTripDriver(req: Request, res: Response): Promise<void> {
  ...
  const data = await transportService.updateTripDriver(
    req.user!.tenantSchema, req.params.id, driver_id ?? null
  );
  res.json({ data });
}
...
export async function markDropped(req: Request, res: Response): Promise<void> {
  ...
  const data = await transportService.markDropped(
    req.user!.tenantSchema, req.params.id, student_id, dropped
  );
  res.json({ data });
}
