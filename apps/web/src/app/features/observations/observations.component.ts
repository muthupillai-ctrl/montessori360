      ...
      <mat-tab label="🎯  Student Progress">
        <div class="tab-body">
          <div class="page-header">
            <div>
              <h1>Observations</h1>
              <div class="subtitle">Track child developmental milestones across all developmental domains</div>
            </div>
          ...
          @if (selectedStudentId()) {
            ...
            <div class="empty-state">
              ...
              <div class="empty-sub">Choose a student above to view their developmental progress across all developmental domains.</div>
            </div>
          }
        </div>
      </mat-tab>
...
export class ObservationsComponent implements OnInit {
  ...
  printReport() {
    ...
    win.document.write('<html><head><title>Observations — ' + studentName + '</title>' +
      ...
      '</div>' +
      html +
      '<div style="margin-top:24px;font-size:11px;color:#9CA3AF;text-align:center">Generated by Taji One</div>' +
      '</body></html>');
    win.document.close();
